      ...
      this.cDragger.on("drop", (el, wrapper, target, silblings) => {
        ...
        const { prev, next } = dragger.sibling({
          ...
          candidates: Array.from(
            wrapper.querySelectorAll(".card-item__container")
          ),
          type: "card"
        });
        if (!prev && next) {
    ...
    setListDragabble() {
      ...
      this.lDragger.on("drop", (el, wrapper, target, silblings) => {
        ...
        const { prev, next } = dragger.sibling({
          el,
          wrapper,
          candidates: Array.from(wrapper.querySelectorAll(".list__container")),
          type: "list"
        });
